...
//     // Tạo danh sách các EventModel từ GroupModel để sử dụng trong Dropdown
//     final List<EventModel> allEvents = widget.groups
//         .expand((group) => group.events!.map((event) => event))
//         .toList();
...
//       },
//       isExpanded: true,
//       hint: Text(intl.eventGroupLabel),
//       items: allEvents.map<DropdownMenuItem<EventModel>>((EventModel event) {
//         // Tìm group tương ứng với event
//         final GroupModel group = widget.groups.firstWhere((g) => g.id == event.groupId);
...
//         labelText: intl.eventGroupLabel,
