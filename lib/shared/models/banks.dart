...
final List<BankInfo> banksList = banks.map((e) => BankInfo(
  id: e['id'].toString(),
  ...
  transferSupported: int.parse(e['transferSupported'].toString()),
  lookupSupported: int.parse(e['lookupSupported'].toString()),
